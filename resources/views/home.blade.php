  ...
  <header id="header" class="header d-flex align-items-center position-relative">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <img src="{{ asset('img/logo.jpeg') }}" alt="AgriCulture">
      ...
      <nav id="navmenu" class="navmenu">
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Perfil</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
      ...
      <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-container">
            <h2>El Poder del Conocimiento Compartido</h2>
            <p>El conocimiento crece cuando lo compartimos: juntos podemos lograr más.</p>
          </div>
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-container">
            <h2>Juntos Somos Invencibles</h2>
            <p>No importa cuán lejos llegues solo, siempre llegarás más lejos en equipo.</p>
          </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-container">
            <h2>La Fuerza de las Ideas</h2>
            <p>Cada idea cuenta, cada voz importa: construyamos el futuro juntos.</p>
          </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-container">
            <h2>El Viaje del Aprendizaje</h2>
            <p>Aprender no es un destino, es un camino que recorremos mejor acompañados.</p>
          </div>
        </div><!-- End Carousel Item -->
        ...
        <div class="carousel-item">
          ...
          <div class="carousel-container">
            <h2>Creatividad en Colaboración</h2>
            <p>La colaboración es la chispa que enciende la creatividad y el progreso.</p>
          </div>
        </div><!-- End Carousel Item -->
          ...
          <div class="row g-0">
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Proyectos Colaborativos</h3>
                  <p>
                  Conecta con personas afines y trabaja en proyectos educativos, 
                  de investigación o creativos. Una manera única de aprender haciendo.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Biblioteca de Recursos Compartidos</h3>
                  <p>
                  Accede a documentos, videos, guías y materiales subidos por la 
                  comunidad para complementar tu aprendizaje.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Foros de Discusión y Resolución de Problemas</h3>
                  <p>
                  Comparte tus dudas y participa en debates para encontrar soluciones
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Talleres y Capacitaciones Virtuales</h3>
                  <p>
                  Únete a talleres en vivo o grabados dirigidos por líderes de la 
                  comunidad para desarrollar nuevas habilidades.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Espacios para Mentores y Aprendices</h3>
                  <p>
                  Encuentra un mentor que te guíe en tu aprendizaje o comparte tu 
                  experiencia ayudando a otros usuarios.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Gestión de Tareas Colaborativas</h3>
                  <p>
                  Organiza y asigna tareas dentro de proyectos, permitiendo a 
                  los equipos trabajar de manera más eficiente y organizada.
            ...
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Reconocimientos y Certificaciones</h3>
                  <p>
                  Gana insignias, reconocimientos o certificados que avalen tus 
                  aportes y tu aprendizaje en la plataforma.
                  </p>
                </div>
              </div>
            </div>
            <div class="col-lg-3 col-md-6">
              <div class="service-item">
                ...
                <div class="service-item-content">
                  <h3 class="service-heading">Red de Contactos Académicos y Profesionales</h3>
                  <p>
                  Construye relaciones significativas con otros estudiantes, 
                  profesores y profesionales que compartan tus intereses.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-6 mb-4 mb-lg-0">
          <div class="video-container" data-aos="zoom-out">
            <video src="{{ asset('videos/hola.mp4') }}" class="img-fluid rounded shadow" autoplay muted loop></video>
            <div class="video-overlay text-center">
              <p class="text-white fw-bold">"La colaboración es la chispa que enciende la creatividad."</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="100">
          <h3 class="content-subtitle text-white opacity-50">¿Por qué la colaboración importa?</h3>
          <h2 class="content-title mb-4">
            Descubre cómo <strong>trabajar juntos</strong> puede cambiar el juego.
          </h2>
          <p class="opacity-75 text-white">
            Cuando colaboramos, nuestras ideas se fortalecen, aprendemos más rápido y creamos soluciones más efectivas. Tu contribución es el inicio de algo más grande.
          </p>
          <ul class="list-unstyled text-white opacity-75">
            <li><i class="bi bi-check-circle me-2"></i> Impulsa tu aprendizaje con otros.</li>
            <li><i class="bi bi-check-circle me-2"></i> Comparte tus talentos y habilidades.</li>
            <li><i class="bi bi-check-circle me-2"></i> Logra más trabajando en equipo.</li>
          </ul>
          <a href="#join" class="btn btn-primary mt-3">Únete ahora</a>
        </div>
      </div>
    </div>
  </div>
...
<section id="services-2" class="services-2 section dark-background">
  <!-- Section Title -->
  <div class="container section-title" data-aos="fade-up">
    <h2>Servicios Colaborativos</h2>
    <p>Fomentamos el crecimiento a través del trabajo en equipo, el intercambio de conocimiento y el aprendizaje continuo.</p>
  </div><!-- End Section Title -->
          ...
          <div class="swiper-slide">
            <div class="service-item">
              <div class="service-item-contents">
                <a href="#">
                  <span class="service-item-category">Ofrecemos</span>
                  <h2 class="service-item-title">Creación de Proyectos Colaborativos</h2>
                </a>
              </div>
              <img src="{{ asset('img/6.jpg') }}" alt="Creación de Proyectos" class="img-fluid">
            </div>
          </div>
          <!-- Servicio 2 -->
          <div class="swiper-slide">
            <div class="service-item">
              <div class="service-item-contents">
                <a href="#">
                  <span class="service-item-category">Ofrecemos</span>
                  <h2 class="service-item-title">Compartir Recursos</h2>
                </a>
              </div>
              <img src="{{ asset('img/7.jpg') }}" alt="Compartir Recursos" class="img-fluid">
            </div>
          </div>
          <!-- Servicio 3 -->
          <div class="swiper-slide">
            <div class="service-item">
              <div class="service-item-contents">
                <a href="#">
                  <span class="service-item-category">Ofrecemos</span>
                  <h2 class="service-item-title">Asignación y Gestión de Tareas</h2>
                </a>
              </div>
              <img src="{{ asset('img/8.jpg') }}" alt="Gestión de Tareas" class="img-fluid">
            </div>
          </div>
      ...
      <div class="container">
        <div class="row gy-4">
          <div class="col-lg-4 col-md-6 footer-about">
            <a href="index.html" class="logo d-flex align-items-center">
              <span class="sitename">TeamLearn</span>
            </a>
